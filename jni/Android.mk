...
LOCAL_CFLAGS    := -DJNI_ENABLED=1 \
	-D__ANDROID__ \
	-DPROJ_LIB="\"/data/data/tk.crazysoft.ego/lib/\""
LOCAL_LDLIBS := -lm
LOCAL_LDLIBS += -llog
LOCAL_SRC_FILES := \
	...
	proj-4.8.0/src/geod_interface.c \
	proj-4.8.0/src/geod_set.c \
	proj-4.8.0/src/geodesic.c \
	...
	proj-4.8.0/src/pj_gridcatalog.c \
