...
public class Environment4 {
    ...
    public final static int TYPE_PRIMARY    = 0;
    public final static int TYPE_INTERNAL   = 1;
    public final static int TYPE_SD         = 2;
    public final static int TYPE_USB        = 3;
     ...
     * man per {@link tk.crazysoft.ego.io.Environment4.Device#isAvailable()}. Die Liste ist
     * somit eher als Geräte-Übersicht nützlich.
     *
     * @see tk.crazysoft.ego.io.Environment4.Device
     *
     * @param context Context des Aufrufers, also this oder in Fragments getActivity()
     * @return eine Liste der passenden {@link tk.crazysoft.ego.io.Environment4.Device}
     */
    ...
    public static class Device extends File {
        String mUserLabel, mUuid, mState, mWriteState;
        int mType;
